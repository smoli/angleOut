...
pub const SCREEN_WIDTH_H: f32 = SCREEN_WIDTH / 2.0;
pub const SCREEN_HEIGHT_H: f32 = SCREEN_HEIGHT / 2.0;
...
pub const PADDLE_THICKNESS_H: f32 = PADDLE_THICKNESS / 2.0;
...
pub const BLOCK_HEIGHT:f32 = 15.0;
pub const BLOCK_HEIGHT_H:f32 = BLOCK_HEIGHT / 2.0;
...
pub const BLOCK_GAP: f32 = BLOCK_WIDTH / 5.0;